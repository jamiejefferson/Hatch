...
export const TOOLS: Tool[] = [...sessionTools, ...hatchTools, ...navigateTools, ...readTools, ...extractTools, ...actTools, ...stepTools, ...jevRunTools, ...projectTools, ...linkTools, ...commentTools, ...credentialTools];
