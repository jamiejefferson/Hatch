...
const PUSHES: (keyof Pushes)[] = ['command', 'activity:event', 'agents:work', 'page:changed', 'page:escape', 'popup:blocked', 'dialog:state', 'projects:state', 'projects:log', 'links:state', 'comments:changed', 'signins:state', 'consent:state', 'connection:state'];
